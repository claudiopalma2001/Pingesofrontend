...
const USERS_API_LOGIN = "http://docedeseosimplementacion-env.eba-nnxjyerc.sa-east-1.elasticbeanstalk.com/api/v1/usuarios/login"
const USERS_API_SAVE ="http://docedeseosimplementacion-env.eba-nnxjyerc.sa-east-1.elasticbeanstalk.com/api/v1/usuarios/save"
const BASE_URL = "http://docedeseosimplementacion-env.eba-nnxjyerc.sa-east-1.elasticbeanstalk.com/api/v1";
...
function getUserByEmail(email){
    const link = `http://docedeseosimplementacion-env.eba-nnxjyerc.sa-east-1.elasticbeanstalk.com/api/v1/usuarios/correo/${email}`
    return axios.get(link)
}

function getUserByIdRol(idRol){
    const link = `http://docedeseosimplementacion-env.eba-nnxjyerc.sa-east-1.elasticbeanstalk.com/api/v1/usuarios/idRol/${idRol}`
    return axios.get(link)
}
