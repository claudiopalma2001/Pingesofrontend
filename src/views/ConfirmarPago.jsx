...
const ConfirmarPago = () => {
  ...
  const handleAuthorizePayment = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:8080/api/v1/pago/webpay/commit', null, {
...
try {
  const response = await axios.get(`http://localhost:8080/api/v1/usuarios/correoId/${correo}`);
